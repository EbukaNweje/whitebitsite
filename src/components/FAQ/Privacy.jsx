...
const Privacy = () => {
  return (
    ...
    <Main>
        ...
        <p style={{color:'gray', fontFamily: "Inter, arial, sans-serif", paddingTop: "2%", paddingLeft: "5%", width:"90%"}}>whitebit.org and its affiliates guarantee and undertake to make every possible effort to protect the Client's confidentiality. whitebit.org may use the information collected about the Customer to fulfill its contractual obligations and optimize customer service.
            <br /> <br />
        Before using the site, please carefully study this document in order to fully understand our position and policy regarding the personal data of Clients and how we will use them.</p>
        <p style={{color:'gray', fontFamily: "Inter, arial, sans-serif", paddingTop: "2%", paddingLeft: "5%", width:"90%"}}>The information provideв by the client The client may provide us with information about himself by filling out the appropriate forms on the site or by providing such information by phone or e-mail, in the course of contacting Client Support or in any other way.
            <br/> <br />
        Information we collect about clients</p>
        ...
        <H1>Each time the client visits our website and uses our services, we can collect the following data about the client (including automatically):</H1>
            ...
            technical information, for example, IP address used to connect the client's computer to the Internet; client login data: browser type and version, operating system, etc.
            </p>
            ...
            <p  style={{color:'gray', fontFamily: "Inter, arial, sans-serif", paddingTop: "2%", paddingLeft: "5%", width:"90%"}}>for the fulfillment of the obligations specified in the agreements concluded with the client, as well as for the purpose of providing the client with the requested information;</p>
